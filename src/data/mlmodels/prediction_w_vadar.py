...
# Suppose you have VADER sentiment scores for home and away teams
# Let's assume they are in columns 'HomeTeamScoreVader' and 'AwayTeamScoreVader'
# Add them to the features list if they exist
vader_cols = ['HomeTeamScoreVader', 'AwayTeamScoreVader']
...
nb_accuracy = accuracy_score(y_test, [game['vadar Naive Bayes'] for game in game_predictions])
print("\nNaive Bayes Accuracy:", nb_accuracy)

lr_accuracy = accuracy_score(y_test, [game['vadar L Regress'] for game in game_predictions])
print("\nLogistic Regression Accuracy:", lr_accuracy)

knn_accuracy = accuracy_score(y_test, [game['vadar KNN'] for game in game_predictions])
print("\nKNN Accuracy:", knn_accuracy)

svm_accuracy = accuracy_score(y_test, [game['vadar SVM'] for game in game_predictions])
